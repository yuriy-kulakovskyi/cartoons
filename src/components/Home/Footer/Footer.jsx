      ...
      <div className="footer__container container">
        <ul className="footer__container__social-links">
          <li className="footer__container__social-links__item">
            <a target="_blank" href="https://www.instagram.com/rickandmorty/" className='footer__container__social-links__item__link'>
          ...
          <li className="footer__container__social-links__item">
            <a target="_blank" href="https://www.facebook.com/RickandMorty" className='footer__container__social-links__item__link'>
